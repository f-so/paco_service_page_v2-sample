  ...
  return (
    <section className="relative py-16 sm:py-24 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 pt-20 pb-12 sm:pt-24 sm:pb-16 text-center text-white">
        <div className="rounded-2xl bg-white/15 backdrop-blur-sm px-4 sm:px-6 py-5 sm:py-6 shadow-[0_0_24px_rgba(45,212,191,0.25)]">
        ...
        <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-10 sm:mb-16">
          <button
            type="button"
        ...
        <div className="max-w-3xl mx-auto rounded-2xl">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6">
            <a
              href="#speed-features"
              className="bg-white/10 backdrop-blur-sm p-3 sm:p-6 rounded-xl block hover:bg-white/20 transition-colors cursor-pointer"
            >
              ...
              <p className="text-xs sm:text-sm">寝てても回る</p>
            </a>
            ...
            >
              ...
              <h3 className="text-sm sm:text-lg font-semibold mb-1 sm:mb-2">
                リアルタイム<br className="sm:hidden" />
                通知
              </h3>
              <p className="text-xs sm:text-sm">Discordに届く</p>
            </a>
            ...
            >
              ...
              <p className="text-xs sm:text-sm">合わなければ解約</p>
            </a>
          </div>
        </div>
      </div>
